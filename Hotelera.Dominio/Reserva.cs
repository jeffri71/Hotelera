...
namespace Hotelera.Dominio
{
    public class Reserva
    {
        ...
        public static Reserva reservarHabitacion(Habitacion id_hab, Cliente id_client,Usuario id_usu,TipoReserva id_tipreserv, MedioReserva id_medioreserv,string estado_reserv,DateTime fecha_reserv, DateTime fecha_ingreso, DateTime fecha_salida, Agregados id_agregad)
        {
            return new Reserva()
            {
        ...
        public void modificarReservacion(Habitacion id_hab, Cliente id_client, Usuario id_usu, TipoReserva id_tipreserv, MedioReserva id_medioreserv, string estado_reserv, DateTime fecha_reserv, DateTime fecha_ingreso, DateTime fecha_salida, Agregados id_agregad)
        {
            ID_Habitacion = id_hab;
            ID_Cliente = id_client;
            ID_Usuario = id_usu;
